          ...
          <div className='navLinks'>
            ...
            >
              <div className='dropdown'>
                ...
                <div className='dropbtn' onClick={handleToggle}>Artists ▼</div>
                {dropdown &&
                  <div className='dropdownContent'>

                    {artists.map(r => (
                      <NavLink onClick={() => setDropdown(false)} key={r.roomN} className={navData => navData.isActive ? 'active' : 'inactive'} to={'/rooms/' + r.slug}>
                        {r.name} ({r.roomN})
                      </NavLink>
                    )
                    )}
            ...
            <NavLink onClick={handleToggle} className={navData => navData.isActive ? 'active' : 'inactive'} to='/about'>About</NavLink>
            {/* <NavLink className={navData => navData.isActive ? 'active' : 'inactive'} to='/feedback'>Feedback</NavLink> */}
          </div>
          ...
          <div className='navLinks'>
            ...
            >
              <div className='dropdown'>
                ...
                <div onClick={handleToggle} className='dropbtn'>Artists ▼</div>
